...
/*
 * 64-bit CPU 线性地址空间分为两部分，内核控制 ULIM 之上的地址空间
 * 为内核保留的虚拟地址空间，[0x8003c00000, 0x7FFFFFFFFFFF) ∪ addr(Canonical "higher half")
 * 用户环境控制下方部分，约(512GB+60MB)[0x0, 0x8003c00000]
 *
 ...
 *                                                    kernel/user
 * 
 *         2^64 ---->  +------------------------------+ 0xFFFFFFFFFFFFFFFF
 *                     |                              |
 *                     |~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~|
 *                     :              .               :
 *                     :              .               :
 *                     :    Canonical "higher half"   : (128 TB)
 *                     :              .               :
 *                     :              .               :
 *                     |~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~|
 *                     |                              |
 ...
 *                     :              .               :
 *                     :              .               :
 *                     :      NonCanonical address    : MSB 16-bit is sign extension
 *                     :              .               :
 *                     :              .               :
 *                     |~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~|
 *                     |                              |
 *     128 TB ------>  +------------------------------+ 0x00007FFF FFFFFFFF
 *                     |                              |
 *                     |~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~|
 *                     :              .               :
 *                     :              .               :
 *                     :    Canonical "lower half"    : (0x0 ~ 0x00007FFF FFFFFFFF)
 *                     :              .               :
 *                     :              .               :
 *                     |~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~|
 *                     |                              |
 *                     +------------------------------+ 0x100 80403000
 *                     |           uvpml4e[]          | R-/R-  uvpt: 2GB 
 *                     |            uvpde[]           |        uvpd: 4MB
 *                     |            uvpd[]            |        uvpde: 8KB
 *     (1 TB) /        |            uvpt[]            |        uvpml4e: PGSIZE
 *     UVPT -------->  +------------------------------+ 0x10000000000
 *                     |                              |
 *                     |~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~|
 *                     :              .               :
